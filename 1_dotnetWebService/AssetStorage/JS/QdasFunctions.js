...
const navData = [
    ...
    },
    {
        ...
        permission_code: "SHOP_EXPLORER.VIEW_SHOP_EXPLORER",
        navPath: "ShopExplorer",
    },
    {
        id: 3,
        title: "Area Explorer",
...
function showAlarm(obj, index) {
    ...
    <div class="col-sm-4">
                <div class="line-layout row"><span class="line-machine col-sm-4 px-0">${obj.component
        }</span>
                 <div   class=" col-sm-2 overall-status"></div>


                  <div class = "col-sm-4 px-0 wrap cursor-pointer user-select-none" onclick="linkFor_model('${obj.area
        }','${obj.component}')">
                              <span class="split-green" title="${obj.ok
        }" style="width:${(obj.ok / (obj.ok + obj.nok)) * 100
        }%;">${obj.ok}</span>
                              <span class="split-red"  title="${obj.nok
        }" style="width:${(obj.nok / (obj.ok + obj.nok)) * 100
        }%;">${obj.nok}</span>
...
function showTimechart(obj, sr_no, result) {
  ...
  <td class="text-align-center"> <a href="#""><div class="oper_desc">Model:${obj.model
        }</div>
    <div class=" timelineChart text-center" id="timeline-chart${sr_no}"></div></a>
  </td>
  <td class="align-items-center"><div class="desc_statustotal text-center">Total-${obj.ok + obj.nok
        }</div></td>
  <td class="align-items-center"><div class="desc_statusok text-center">OK-${obj.ok
        }</div></td>
  <td class="align-items-center"> <div class="desc_statusnotok text-center">NOK-${obj.nok
        }</div></td>
